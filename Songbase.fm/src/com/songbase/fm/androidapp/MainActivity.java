...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final ProgressBar progressBar = (ProgressBar) findViewById(R.id.progressBarSong);
		...
		// planetsList);
		aAdpt = new SonglistAdapter(songlist, this);
		lv.setAdapter(aAdpt);
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		Song planet = aAdpt.getItem(aInfo.position);
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		AdapterContextMenuInfo aInfo = (AdapterContextMenuInfo) item
				.getMenuInfo();
		songlist.remove(aInfo.position);
	...
	private void initList() {
		...
		songlist.add(new Song("Mercury", 10));
		songlist.add(new Song("Venus", 20));
		songlist.add(new Song("Mars", 30));
		songlist.add(new Song("Jupiter", 40));
		songlist.add(new Song("Saturn", 50));
		songlist.add(new Song("Uranus", 60));
		songlist.add(new Song("Neptune", 70));
		songlist.add(new Song("Mercury", 10));
		songlist.add(new Song("Venus", 20));
		songlist.add(new Song("Mars", 30));
		songlist.add(new Song("Jupiter", 40));
